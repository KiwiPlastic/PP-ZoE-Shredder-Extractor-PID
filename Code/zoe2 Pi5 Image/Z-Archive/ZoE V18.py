...
#
# <F11> toggels full screen
# <ESC> close prog
#==================================================================
#==================================================================
# GPIO H/W pin assignment, using GPIO labeling, not pin header
# GPIO 0  (ID_SD)
# GPIO 1  (ID_SC)
# GPIO 2  (I2C SDA)   		
# GPIO 3  (I2C SCL)  		
# GPIO 4  (GP CLK0)  	            1-Wire Temperature sensor Data         I/O
...
helptxt = """
24-9-25  V18  ZoE, Richard Nicholson, New Zealand
...
"""
#===========================================================================================
import glob										# used by 1 wire tempreture sesnors
...
OPTO1 		= 5			# Encoder Opto Intrupter IP
OPTO2 		= 6

ESHUTDOWN 	= 26			# Emergancy Shut Down Button IP

HEATER1 = LED(22)		# Heat Band SSR  OP
HEATER2 = LED(23)
HEATER3 = LED(24)

ALMBUZZER = LED(25)		# Buzzer OP
#STATUS_LED = LED(26)	# Status Led OP

# 1 wire Temperature sesnors
sensor1 = glob.glob("/sys/bus/w1/devices/" + "28-000000784af1")[0] + "/w1_slave"
sensor2 = glob.glob("/sys/bus/w1/devices/" + "28-0000007252a4")[0] + "/w1_slave"
sensor3 = glob.glob("/sys/bus/w1/devices/" + "28-000000784012")[0] + "/w1_slave"
...
# ===================================
def savefile():					# once a file is loaded it can be saved and updated
