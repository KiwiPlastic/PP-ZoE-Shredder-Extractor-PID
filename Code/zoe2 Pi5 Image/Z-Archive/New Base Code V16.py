...
helptxt = """
27-9-20  V16       By Richard Nicholson, New Zealand
...
Operation:
Program starts in full screen mode, (<F11> toggel full screen), as its written to work on 7" touch screen
It will imediately start graphing temperatures and PID output = zero.
