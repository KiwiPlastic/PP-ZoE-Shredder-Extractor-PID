...
# input fild fonts - done
# blank the spacer label - done
# row 13 buttons spacing - done
# correct labels - done

#To Do
# <ESC> = quit key, working
# link entry values to variables
# functions to make heater/manual buttons work for GUI Leds and GPIO
...
led_manual.to_green() 
led_heater1.to_green(True)
led_heater2.to_green()
led_heater3.to_green()
