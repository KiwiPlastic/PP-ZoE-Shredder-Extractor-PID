# 20-8-20 Bliting code Ver 4
# shows 3 graphs 200 samples wide, reads 3 x MAX6675 SPIs
# untill this version, it normaly has memory leaks in matplotlib
...
# - get a while loop working to test it (print temps) - DONE V5
# - grapht figure size position or overlaying makes for flicker  
# - sort out reading temps and passing values to graphs= inefficent @ minute. BUS to buzzy???
...
#---------------------------------------------------------------------------------------------
# clean up from any prvious program test runs.
plt.close('all')
...
# Add labels
plt.title('Sensor 1 MAX6675 Temperature over Time')
plt.xlabel('Samples')
...
# Add labels
plt.title('Sensor 2. MAX6675 Temperature over Time')
plt.xlabel('Samples')
plt.ylabel('Temperature2 (deg C)')
...
# Add labels
plt.title('Sensor 3. MAX6675 Temperature over Time')
plt.xlabel('Samples')
plt.ylabel('Temperature (deg C)')
