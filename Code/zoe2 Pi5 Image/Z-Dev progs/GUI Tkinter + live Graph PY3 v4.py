...
# 24-8-20 v4 = V9 of original Bliting code that this is based on
...
# GOALS
# Adjust graph size, inside figure, not sure howto. But got three graphs working-live
# tidy up graphs - fit DONE V4
# code for PID
# 
#set up framwork to do what is required, butoons and iputs
...
sample_Int = 600    #Graph update sample interval in ms 1000 = 1 Sec
...
class SeaofBTCapp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        tk.Tk.wm_title(self, "ZoE Master Control V4")
