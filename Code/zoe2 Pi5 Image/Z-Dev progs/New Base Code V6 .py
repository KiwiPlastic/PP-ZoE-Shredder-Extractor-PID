...
# Add notes - Done V6
# Add GPIO heaters and alarm buzzer - DONE V6 init, not fully implimented
# GUI Interface setup,  
# Add functional suport code for heaters and alarms output
...
#-----------------------------------------------------------------------------------------------------
# This is the main Engine. It reads the Temperatures, does PID calc and turns Heatbands On/Off, alarms
...
# Create other supporting widgets (labels, buttons, Input entry )
...
label_celsius1 = tk.Label(frame, textvariable=Temp1GUI, font=dfont, bg='white')
label_Target1 = tk.Label(frame, text='Target Temp1 :', font=dfont, bg='white')
label_power1 = tk.Label(frame, text='Power 1 out :', font=dfont, bg='white')
label_powervalue1= tk.Label(frame, textvariable=pid1GUI, font=dfont, bg='white')
label_P1 = tk.Label(frame, text='P1: ', font=dfont, bg='white')
label_I1 = tk.Label(frame, text='I1: ', font=dfont, bg='white')
label_D1 = tk.Label(frame, text='D1 :', font=dfont, bg='white')
label_pidout = tk.Label(frame, text='PID O/P :', font=dfont, bg='white')
label_alarm = tk.Label(frame, text='Power 1 out:', font=dfont, bg='white')

entry_target1 = tk.Entry(frame, text="Target Temp1:", width=10)
entry_P1 = tk.Entry(frame, width=10)
entry_I1 = tk.Entry(frame, width=10)
entry_D1 = tk.Entry(frame, width=10)
entry_top_left = tk.Entry(frame, width=10)
entry_top_right = tk.Entry(frame, width=10)
entry_tot_left = tk.Entry(frame, width=10)
entry_bot_left = tk.Entry(frame, width=10)
...
# this is the plot, starts at 0,0 spans 5 rows (down) and spans  4 colums (across)
...
entrytarget1.grid (row = 0, column = 4)
              
Inputentry.grid(row = 0, column=3)
    
button_pid.grid(row=5, column=0, columnspan=2)
button_temp.grid(row=5, column=2, columnspan=2)
