...
#To Do
# GUI line between PIDs
# config window
# Read and Save profiles to disk
...
#-----------------------------------------------------------------------------------------
# Button: Save as... Data to disk. This is Development to Read and Write profiles
def save_file():
...
#-----------------------------------------------------------------------------------------
# Button: Load... Data from disk. This is Development to Read and Write profiles
def load_file():

    print ("at load file")
    
#-----------------------------------------------------------------------------------------
# Button: Configuration... Data from disk. This is Development to Read and Write profiles
def config():
...
def help_window():
    ...
    top.geometry('950x900')
    top.title("Help Window")
    msg = tk.Message(top, text=helptxt, font = 12, width = 950)
    msg.pack()
