...
# New Base Code V2
#
# Goal :- Get 3 x graphs up
# One garph, var labels configured for three.
...
def animate(i, ax1, ax2, xs, temp1, temp2, temp3, Temp1a, Temp2b, Temp3c):
    ...
    #temps.append(new_temp1)
    #lights.append(new_temp2)
...
fargs = (ax1, ax2, xs, temp1, temp2, temp3, Temp1a, Temp2b, Temp3c)
